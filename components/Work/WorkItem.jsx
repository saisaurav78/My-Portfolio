...
const WorkItem = ({href,category,img,title}) => {
  return (
      ...
      <div className="flex items-center justify-center">
        ...
        <button className="bg-accent text-white rounded-full w-[48px] h-[48px] flex items-center justify-center -rotate-45 group-hover:rotate-0 transition-all duration-500"><FiArrowRight className="text-2xl"/></button>
      </div>
      </Link>
  )
}
